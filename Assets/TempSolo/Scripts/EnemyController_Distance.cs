...
public class EnemyController_Distance : EnemyAIBase
{
    ...
    [SerializeField]
    [Header("Разброс пуль")]
    private float spreadBullets = 1.0f;
    ...
    [SerializeField] private float callFriendsDistance = 5;
    ...
    private void Idle()
    {
        ...
        if (currentTargetPlayer)
        {
          ...
          //  if (SoundManagerAllControll.Instance && attackClip) SoundManagerAllControll.Instance.ClipPlay(attackClip, source, SoundManagerAllControll.SoundPriority.background);
        }
    }
    ...
    private void Patrol()
    {
      ...
      //      enemyAnimator.SetAnimatorLayerWeight(1, 0);
        ...
        {
            stateEnemy = StateEnemy.idle;
          //  if (SoundManagerAllControll.Instance && idleClip) SoundManagerAllControll.Instance.ClipPlay(idleClip, source, SoundManagerAllControll.SoundPriority.background);
        }
        else
        {
    ...
    private void Attack()
    {
        ...
        else
        {
          ...
          //  if (SoundManagerAllControll.Instance && patrolClip) SoundManagerAllControll.Instance.ClipPlay(patrolClip, source, SoundManagerAllControll.SoundPriority.background);
            return;
        }
        ...
        if (currentTargetPlayer && targetGun)
        {
            ...
            tempTargetGun.x += Random.Range(-spreadBullets, spreadBullets);
            tempTargetGun.y += Random.Range(-spreadBullets, spreadBullets);
       ...
       //     enemyAnimator.SetAnimatorLayerWeight(1, 0);
        ...
        if (stateEnemy != StateEnemy.death)
        {
         ...
         //   enemyAnimator.SetStateAnimator(speed, currentSpeed);
          ...
          //  if (SoundManagerAllControll.Instance && deathClip) SoundManagerAllControll.Instance.ClipPlay(deathClip, source, SoundManagerAllControll.SoundPriority.background);
    ...
    private bool CheckInDamage()
    {
        ...
        //         {
        //             if (questAction != null)
        //             {//судя по всему когда бот меняет состояние currentTarget сбрасывается и он не может найти QuestManager
        ...
        //             if (needHelp)                 // ����� �� ������
        //             {
        //                 CallForHelp(callFriendsDistance);
        //             }
        //         }
        //     }
        //
